...
def run_all() -> int:
    ...
    tests = [
        ...
        # Round 35 C1 + r36 H1 ProgressTracker language-aware tests
        # moved to tests/test_progress_tracker_language.py in round 47
        # Step 4 (preventive split — this file was 765 -> 599 lines).
