...
tests/   — test_all(meta) → api_client(19) + file_processor(33) + translators(24) + glossary_prompts_config(24) + translation_state(13) = 113
           ...
           + editor(13) + custom(20) + direct_pipeline(2) + tl_pipeline(2) = 302
```
